...
def pingpong(n):
    ...
    def helper(index, value, state):
        ...
        if num_sevens(index) > 0 or index % 7 == 0:
            ...
            return helper(index+1, value-state, -state)
        else:
            return helper(index+1, value+state, state)
...
def missing_digits(n):
    ...
    def helper(n, last, count):
        if n == 0:
            ...
            if (last - (n//10)%10 > 1) and n//10 != 0:
                return helper(n, last-1, count+1)
            else:
                return helper(n//10, (n//10)%10, count)
